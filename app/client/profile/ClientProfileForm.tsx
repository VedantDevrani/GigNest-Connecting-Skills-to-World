...
export function ClientProfileForm({ initialProfile }: { initialProfile: Profile }) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="col-span-1 md:col-span-2 p-6 bg-white dark:bg-gray-900 shadow-sm border-gray-100 dark:border-gray-800">
                    <form onSubmit={handleSave} className="space-y-6">
                        ...
                        <Input label="Company / Display Name" name="name" value={formData.name} onChange={handleChange} required />
