...
import { CreditCard, Wallet, CheckCircle, Clock, ExternalLink } from 'lucide-react';
...
export function FreelancerEarningsView({
    initialContracts,
    analytics,
}: {
    initialContracts: EarningsContract[];
    analytics: Analytics;
}) {
    return (
        <div className="space-y-6 max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="p-6 bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden">
                    <div className="flex justify-between items-start z-10 relative">
                        <div>
                            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Pending Amount</p>
